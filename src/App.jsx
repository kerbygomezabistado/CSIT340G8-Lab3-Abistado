...
const Part = (props) => {
  return (
    <p>
      {props.partName} (Units: {props.units})
    </p>
  )
}
...
const Content = (props) => {
  return (
    <div>
      <Part partName={props.part1} units={props.exercises1} />
      <Part partName={props.part2} units={props.exercises2} />
      <Part partName={props.part3} units={props.exercises3} />
    </div>
  )
}
